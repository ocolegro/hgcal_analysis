...
arr       = u.prep_smear(u.load_event_array(db.electrons.find(no_cursor_timeout=True).limit(n_events)),False,[11.])
...
#arr = u.prep_smear(u.load_event_array(db.ele_gamma.find(no_cursor_timeout=True).limit(n_events)),True,[11.,22.])
