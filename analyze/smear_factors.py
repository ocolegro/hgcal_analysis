...
arr = u.prep_mask(u.load_event_array(db.electrons_finer.find(no_cursor_timeout=True).limit(n_events)),
                   u.load_event_array(db.electrons_finer.find(no_cursor_timeout=True).limit(n_events)),500000)
