...
//
  ...
  analysisManager->CreateNtuple("Brem", "Brem");

  analysisManager->CreateNtupleDColumn("Eng_ele");
  analysisManager->CreateNtupleDColumn("Eng_phot");
  analysisManager->CreateNtupleDColumn("Theta_ele");
  analysisManager->CreateNtupleDColumn("Theta_phot");
  analysisManager->CreateNtupleDColumn("Phi_ele");
  analysisManager->CreateNtupleDColumn("Phi_phot");
  analysisManager->CreateNtupleIColumn("Run_numb");
